...
async function connectVPN(page) {
  try {
    // Navigate to the Chrome extensions page
    await page.goto(
      "chrome-extension://fgddmllnllkalaagkghckoinaemmogpe/popup.html"
    );
    ...
    // Note: You'll need to replace SELECTOR with the actual selector
    // This might require manual inspection of the extension's HTML
